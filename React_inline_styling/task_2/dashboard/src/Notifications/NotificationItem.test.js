...
describe('<Notifications />', () => {
  ...
  // Will check that when simulating a click on the component, the spy is called with the right ID argument
  it('Will Check that when simulating the click on the component, the spy is called with the right ID argument', () => {
    const wrapper = shallow(<Notifications />);
    expect(wrapper.props().markAsRead);
  });
