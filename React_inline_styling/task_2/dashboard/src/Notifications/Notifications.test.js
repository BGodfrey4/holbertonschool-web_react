...
describe('notification', () => {
  ...
  // authenticates that when updating the props of the component with the same list, the component doesn’t rerender
  it('authenticates that when updating the props of the component with the same list, the component doesn’t rerender', () => {
    const wrapper = shallow(<Notifications listNotifications={listNotifications} displayDrawer={true} />);
  ...
  // authenticates that when updating the props of the component with a longer list, the component does rerender
