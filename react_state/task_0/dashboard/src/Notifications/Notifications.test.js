...
describe("Notification testings", () => {
  ...
  it("displays menuitem if displayDrawer is false", () => {
  ...
  it(" if display notifications return false will not return when displayDrawer is false", () => {
    const wrapper = shallow(<Notifications displayDrawer={false} />);

    expect(wrapper.find("div.Notifications").exists()).toBe(false);
  });

  it("will not display menuItem when displayDrawer is true", () => {
    const wrapper = shallow(<Notifications displayDrawer={true} />);
  ...
  it("doesnt render when the list passed as a prop is same", () => {
    const wrapper = shallow(<Notifications displayDrawer={true} listNotifications={listNotifications} />);
